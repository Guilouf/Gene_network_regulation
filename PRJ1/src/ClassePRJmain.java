...
public class ClassePRJmain  {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int taillepop = 200 ;
        int taillegeno = 5 ;
        double seuilmut = 1 ; // 0.99 = 1% donc c'est pas terrible
        double seuilKO  = 0 ;
...
//        System.out.print("Calcul... ");
        ...
        /////////Generation objects instantiation
        Generation genera1 = new Generation(taillepop, taillegeno) ; // generation of parents
        Generation genera2 = new Generation(taillepop, taillegeno) ; //generation created from parents
        Generation KO =  new Generation(taillepop, taillegeno) ; // copies of curent generation to test KOs
        ...
        int iPAS = 0 ;  //todo voit pas trop l'interet..
        int i = 0 ;
        while (i < nbgenera) {

            //OPERATION PRIMAIRE
            genera2.naissances(genera1, seuilmut, nbmutsurgeno ); //generating a new generation from parents
...
//                donne.set(i, 2, genera2.getNbMUT());
                ...
                String KO4moysp = Double.toString(KO4.getMoySpdvia());
                String KO5prvia = Double.toString(KO5.getPourcevia());
                String KO5moysp = Double.toString(KO5.getMoySpdvia());
